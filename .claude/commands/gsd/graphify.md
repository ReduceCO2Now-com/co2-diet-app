...
Knowledge graph is disabled. To activate:
  ...
  node /Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs config-set graphify.enabled true
...
```bash
node /Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify query <term>
```
...
```bash
node /Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs graphify diff
```
...
```bash
node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build
```
...
graphify update . \
  ...
  && node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify build snapshot \
  && node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" graphify status
```
