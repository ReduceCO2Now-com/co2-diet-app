...
```bash
INIT=$(node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" init plan-phase "$PHASE")
...
```bash
PHASE_INFO=$(node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}")
```
...
```bash
node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" state planned-phase --phase "${PHASE}" --name "${phase_name}" --plans "${PLAN_COUNT}"
```
