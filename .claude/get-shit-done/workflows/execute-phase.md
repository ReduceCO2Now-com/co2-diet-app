...
@/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/context-budget.md
...
- Executor agents omit extended deviation rule examples and checkpoint examples from inline prompt — load on-demand via @/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/executor-examples.md
- Planner agents omit extended anti-pattern lists and specificity examples from inline prompt — load on-demand via @/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/planner-antipatterns.md
...
2. For each plan (sequentially, ignoring wave grouping):
   ...
   c. **If "Execute":** Read and follow `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/workflows/execute-plan.md` **inline**
   ...
   **Sequential dispatch for parallel execution (waves with 2+ agents):**
   ...
   Agent(
     ...
     prompt="
       ...
       @/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/checkpoints.md
       @/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/tdd.md
       @/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/worktree-path-safety.md
       ${CONTEXT_WINDOW < 200000 ? '' : '@/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/references/executor-examples.md'}
       </execution_context>
...
Read and follow `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/workflows/transition.md`, passing through the `--auto` flag so it propagates to the next phase invocation.
