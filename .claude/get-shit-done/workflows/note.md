...
- **Global scope**: `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/notes/`)
...
2. Glob `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/notes/` — works in any directory
