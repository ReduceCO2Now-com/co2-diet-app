...
INSTALL_JS_GLOBAL="/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
