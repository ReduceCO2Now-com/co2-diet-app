...
```
Agent(
  prompt="Read /Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/templates/VALIDATION.md`
