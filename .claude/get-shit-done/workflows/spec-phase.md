...
```bash
INIT=$(node "/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/get-shit-done/templates/spec.md.
