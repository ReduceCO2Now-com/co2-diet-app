...
The keys live in `.claude/settings.json` (project) or `/Users/alisafi/Documents/ReduceCO2-Now/Co2-diet-app/.claude/settings.json` (global) — **not** in `.planning/config.json`:
